(function($){
    $(document).on('click', '.fc-day', function(){
        ...
        console.log(date);
        $('#fullcalendar').css('display', 'none'); // Correct way to hide element
        alert(date); // Alert the selected date
    });
})(jQuery);
...
// // Set default settings if no cookies are present
// function applyDefaultSettings() {
//     if (!getCookie('nav-flat')) {
//         $('body').addClass('nav-flat'); // Default collapsed
//         setCookie('nav-flat', 'true');
//     }

//     if (!getCookie('nav-child-indent')) {
//         $('body').addClass('nav-child-indent'); // Default fixed layout
//         setCookie('nav-child-indent', 'true');
//     }
